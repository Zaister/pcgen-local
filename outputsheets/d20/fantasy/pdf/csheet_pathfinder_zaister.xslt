...
<xsl:stylesheet version="1.0"
	...
	<xsl:import href="pathfinder_common_zaister.xslt"/>
							...
							<fo:table-body>
								...
								<fo:table-row>
									...
									<fo:table-cell number-rows-spanned="2">
										...
										<xsl:apply-templates select="basics/burn"/>
			...
			<fo:page-sequence >
				...
				<fo:flow flow-name="body">
					<fo:block>
						...
						<xsl:apply-templates select="weapons">
							<xsl:with-param name="first_weapon" select="6"/>
